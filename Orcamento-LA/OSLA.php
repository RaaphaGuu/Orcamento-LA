...
<html lang ="pt-BR">
   ...
   */              echo"</table>";
          echo "<table border='1' width='100%'>";
            ...
            echo "<tr><td colspan='4' align='center'><strong><h2> Cadastro do Solicitante:</h2>  <h1>Ordem Nº: $ordem</h1></strong></td>";
            ...
            echo "<tr><td><strong>Equipamento:</strong></td><td>$equipamento</td><td colspan='2'></td></tr>";

            echo "<tr><td><strong>Modelo:</strong></td><td>$modelo</td><td colspan='2'></td></tr>";
            echo "</table>";
